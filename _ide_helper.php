...
')
     ...
     *
     */ 
        class ApplicantEvaluationRequest {
     ...
     *
     */ 
        class CommentOpportunityRequest {
     ...
     *
     */ 
        class NewProjectsRequestRequest {
