            ...
            <div class="row align-items-center flex-wrap-reverse flex-md-wrap">
                ...
                <div class="col-md-8 pe-3 ps-3 pe-md-5">
                    ...
                    <h5 class="text-primary my-3 fw-bold">
                        إزاي ممكن تستفيد من ونس؟
                    </h5>
                    <p>
                        لو معاك عربية وبتسافر في اي مكان تقدر تنزل الرحلة وتستفيد
                        ان ناس تركب معاك وتشارك معاك تكاليف الرحلة لو مش معاك عربية وبتسافر تقدر تشوف حد قريب منك بيسافر للمكان الي عاوره
                        وتركب معاه وتوفر علي نفسك قرف ووجع دماغ المواصلات. تقدر تشوف حد تشارك معاه أو يشاركك سفر دوري زي السفر اليومي للعمل وخلافه.
                    </p>
                    <h5 class="text-primary my-3 fw-bold">
                        ازاي نضمن الشخص الي هيركب معانا او هـنركب معاه؟
                    </h5>
                    <p>
                        تطبيق ونس فيه اكتر من طريقة لعمل Verification. مثلا مينفعش حد يشترك في رحلة الا لو حسابة مؤكد برقم
                        الموبايل وصورة شخصية وبطاقة شخصي.
                        ومينفعش حد ينزل رحلة علي التطبيق الا لو حسابة مؤكد كصاحب سيارة
