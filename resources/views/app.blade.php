...
<head>
    ...
    <meta name="keywords" content="Base Structure"/>
    <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
    <link rel="shortcut icon" href="{{asset('UI/assets/images/roqay-logo.png')}}" type="image/x-icon" sizes="32*32"/>
...
<script>
    @if(request('is-inactive'))
        alert('Your account is inactive, please contact the admin to activate it')
