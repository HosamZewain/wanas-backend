    ...
    <ul class="navbar-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu slideUp2">
                <li class="header"> إختصارات</li>
                <li class="body">
                    <ul class="menu app_sortcut list-unstyled">
                        <li>
                            <a href="{!! url('admin/trips') !!}">
                                <div class="icon-circle mb-2 bg-danger"> <i class="zmdi zmdi-pin-drop"></i></div>
                                <p class="mb-0">الرحلات </p>
                            </a>
                        </li>
                        <li>
                            <a href="{!! url('admin/contact_us') !!}">
                                <div class="icon-circle mb-2 bg-blue"><i class="zmdi zmdi-camera"></i></div>
                                <p class="mb-0">رسائل التواصل</p>
                            </a>
                        </li>
                        <li>
                            <a href="{!! url('admin/settings/1/edit') !!}">
                                <div class="icon-circle mb-2 bg-amber"> <i class="zmdi zmdi-settings"></i></div>
                                <p class="mb-0">الاعدادات</p>
                            </a>
                        </li>
                    </ul>
                </li>
