@extends('dashboard.layouts.app',[
    'breadcrumb_1'=>trans('dashboard.countries'),
    'add_link'=> 'admin/countries/create',
                        ...
                        <table class="table table-hover c_table theme-color" aria-label="d">
                            ...
                            @foreach($resources as $resource)
                                <tr id="row_{!! $resource->id !!}">
                                    ...
                                    <td>{!! $resource->code  !!}</td>
                                    <td>
                                            <button onclick="location.href='{!! route('countries.edit',$resource->id) !!}'"
                                                    class="btn btn-default btn-sm"
                                                    href="{!! route('countries.edit',$resource->id) !!}">
                                                <em class="zmdi zmdi-edit"></em>
                                            </button>

                                                <button
                                                    data-route="{!! route('countries.destroy',$resource->id) !!}"
                                                    data-id="{!!$resource->id !!}"
